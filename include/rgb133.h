...
# define RGB133_MODULE_NAME     "Vision-7.27.1.40643"
# define RGB133_CHAR_VERSION    "7.27.1.40643"
# define RGB133_WIDE_VERSION   L"7.27.1.40643"
#ifdef RGB133_RELEASE_BUILD
# define RGB133_MAJOR_VERSION   7
# define RGB133_MINOR_VERSION   27
# define RGB133_RELEASE_VERSION 1
#else
...
# define RGB133_MODULE_NAME     "VisionLC-1.4.0.40643"
# define RGB133_CHAR_VERSION    "1.4.0.40643"
# define RGB133_WIDE_VERSION   L"1.4.0.40643"
#ifdef RGB133_RELEASE_BUILD
# define RGB133_MAJOR_VERSION   1
# define RGB133_MINOR_VERSION   4
...
typedef struct _rgb133_capture {
      ...
      /* Requested coordinates of image in capture buffer.
       * Not affected by condition changes, e.g. new signal detection.
       * Used in calculations to set up new current coordinates on events
       * which affect image placement in the capture buffer.
       * Not used in calculations to set up buffer IO.
       */
      unsigned int ReqComposeLeft;
      unsigned int ReqComposeTop;
      unsigned int ReqComposeWidth;
      unsigned int ReqComposeHeight;

      /* Current coordinates of image placement in the capture buffer.
       * May be modified by e.g. new signal detection.
       * Used in calculations to set up buffer IO.
       */
