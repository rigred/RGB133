...
#ifdef __KERNEL__
#ifndef RGB133_CONFIG_HAVE_STRUCT_TIMEVAL
#include <linux/videodev2.h>
typedef struct __kernel_v4l2_timeval sTimeval;
#else /* RGB133_CONFIG_HAVE_STRUCT_TIMEVAL */
#include <linux/time.h>
typedef struct timeval sTimeval;
#endif /* !RGB133_CONFIG_HAVE_STRUCT_TIMEVAL */
